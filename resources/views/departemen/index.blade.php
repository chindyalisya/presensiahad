            ...
            <div class="row">
                <div class="col-12">
                    ...
                    @endif
                          ...
                          <div class="row">
                           <div class="col-12">
                           <a href="#" class="btn btn-primary" id="btnTambahDepartemen" data-bs-toggle="modal" data-bs-target="#modal-inputdepartemen">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="input-icon mb-3">
                                        ...
                                        <input type="text" value="" id="kode_dept" name="kode_dept" class="form-control" placeholder="Kode Dept">
                                        </div>
                                    </div>
                                    </div>
                                    <div class="row">
                        ...
                        @push('myscript')
                            ...
                            $(function() {
                                ...
                                $("#frmKaryawan").submit(function(event) {
                                    ...
                                    // If all fields are valid, submit the form (optional)
                                    this.submit();
                                });
                                });
                            </script>
