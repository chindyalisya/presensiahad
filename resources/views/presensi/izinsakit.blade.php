                    ...
                    <div class="row">
                        <div class="col-3">
                            <div class="input-icon mb-3">
                                ...
                                <input type="text" value="{{ Request('nik') }}" id="nik" name="nik" class="form-control" placeholder="Nik">
                            </div>
                        </div>
                        <div class="col-3">
                            <div class="input-icon mb-3">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="/presensi/{{ $d->id }}/batalkanizinsakit" class="btn btn-sm btn-danger">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icon-tabler-square-rounded-x">
                                        <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                <button class="btn btn-primary w-100" type="submit">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icon-tabler-send">
                                        <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                                        <path d="M10 14l11 -11" />
